                    ...
                    <div class="product-img-slide pro-v2 pro-v4">
                        <div class="product-images quickview">
                            <div class="main-img js-product-slider-normal">
                                <a href="#" class="hover-images effect"><img src="{{asset('')}}images/img72.jpg" alt="photo" class="img-responsive"></a>
                                <a href="#" class="hover-images effect"><img src="{{asset('')}}images/img72.jpg" alt="photo" class="img-responsive"></a>
                                <a href="#" class="hover-images effect"><img src="{{asset('')}}images/img72.jpg" alt="photo" class="img-responsive"></a>
                                <a href="#" class="hover-images effect"><img src="{{asset('')}}images/img72.jpg" alt="photo" class="img-responsive"></a>
                                <a href="#" class="hover-images effect"><img src="{{asset('')}}images/img72.jpg" alt="photo" class="img-responsive"></a>
                        ...
                        <div class="multiple-img-list js-click-product-normal pro-v2">
                            <div class="product-col pro-v2">
                                <div class="img active pro-v2 pro-v4">
                                    <img src="{{asset('')}}images/img63.jpg" alt="photo" class="img-responsive">
                                </div>
                            </div>
                            <div class="product-col pro-v2">
                                <div class="img pro-v2 pro-v4">
                                    <img src="{{asset('')}}images/img64.jpg" alt="photo" class="img-responsive">
                                </div>
                            </div>
                            <div class="product-col pro-v2">
                                <div class="img pro-v2 pro-v4">
                                    <img src="{{asset('')}}images/img65.jpg" alt="photo" class="img-responsive">
                                </div>
                            </div>
                            <div class="product-col pro-v2">
                                <div class="img pro-v2 pro-v4">
                                    <img src="{{asset('')}}images/img66.jpg" alt="photo" class="img-responsive">
                                </div>
                            </div>
                            <div class="product-col pro-v2">
                                <div class="img v2">
                                    <img src="{{asset('')}}images/img73.jpg" alt="photo" class="img-responsive style">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-5 col-sm-5 col-xs-12">
                    <div class="product-info s8 pro-v1 pro-v2 pro-v4">
                        ...
                        <div class="short-desc">
                            <p class="product-desc s8 pro-v1 pro-v2 pro-v4">Typography is the work of typesetters, compositors, typographers,<br> graphic designers, art directors, manga artists,comic book artists,<br> graffiti artists.</p>
                        </div>
                        <div class="color pr1 pro-v2 pro-v4">
                            <h4>Color</h4>
                            <ul>
                ...
                <div id="desc" class="tab-pane fade in ">
                    ...
                    <div class="row two">
                        <div class="col-md-4 col-sm-5 col-xs-12">
                            <div class="img-v4">
                                <a href="#" class="plus-zoom"><img src="{{asset('')}}images/img36.jpg" alt="img"></a>
    ...
    <div class="shop-the-look">
        <div class="container">
            <div class="title-pro-v1">
                <h3 class="related-title text-center v2">Shop the look</h3>
            </div>
            <div class="img-boy">
                <a href=""><img src="{{asset('')}}images/img74.jpg" alt=""></a>
                <div class="number">
                    <p>Printed T-Shirt</p>
                    <div class="sale-img shop1 pro-v2">
                        <div class="before shop1 pro-v2"></div>
                    </div>
                    <a href="">1</a>
                </div>
                <div class="number two">
                    <p>Beanie</p>
                    <div class="sale-img shop1 pro-v2 nbt">
                        <div class="before shop1 pro-v2 nbt"></div>
                    </div>
                    <a href="">2</a>
                </div>
                <div class="number three">
                    <p>Jean</p>
                    <div class="sale-img shop1 pro-v2 nb3">
                        <div class="before shop1 pro-v2"></div>
                    </div>
                    <a href="">3</a>
                </div>
                <div class="number four">
                    <p>Shoe</p>
                    <div class="sale-img shop1 pro-v2 nb4">
                        <div class="before shop1 pro-v2"></div>
                    </div>
                    <a href="">4</a>
                </div>
            ...
            <div class="t-shirt">
                <a href=""><img src="{{asset('')}}images/img75.jpg" alt=""></a>
                <a href=""><img src="{{asset('')}}images/img76.jpg" alt=""></a>
                <a href=""><img src="{{asset('')}}images/img77.jpg" alt=""></a>
                <a href=""><img src="{{asset('')}}images/img78.jpg" alt=""></a>
            </div>
        </div>
    </div>
    <div class="container">
        <div class="product-related pd-products">
            <div class="title-pro-v1">
                ...
                <p>View All Products<a href=""><i class="fa fa-angle-right" aria-hidden="true"></i></a></p>
            </div>
            <div class="owl-carousel owl-theme owl-cate v2 js-owl-cate">
                <div class="product-item pro-v1 ">
                    <div class="product-img">
                        ...
                        <div class="sale-img shop1 shop2">
                            <div class="before shop1 v2 pro-v1 product-v2-before"></div>
                        </div>
                        <div class="ribbon zoa-hot shop-v1 product-v2"><span>New</span></div>
                ...
                <div class="product-item pro-v1">
                    <div class="product-img">
                        <a href=""><img src="{{asset('')}}images/img50.jpg" alt="" class="img-responsive"></a>
                        <div class="product-button-group product-details">
                            <a href="#" class="zoa-btn zoa-quickview">
                                <span class="fa fa-shopping-bag"></span>
                            </a>
                ...
                <div class="product-item pro-v1">
                    <div class="product-img">
                        <a href=""><img src="{{asset('')}}images/img51.jpg" alt="" class="img-responsive"></a>
                        <div class="product-button-group product-details">
                            <a href="#" class="zoa-btn zoa-quickview">
                                <span class="fa fa-shopping-bag"></span>
                            </a>
                ...
                <div class="product-item pro-v1">
                    <div class="product-img">
                        ...
                        <div class="sale-img shop1 shop2 st-v2">
                            <div class="before shop1 v2 pro-v1 product-v2-before st-v2"></div>
                        </div>
                        <div class="ribbon zoa-hot shop-v1 product-v2 v2"><span>-25%</span></div>
                        <div class="product-button-group product-details">
                            <a href="#" class="zoa-btn zoa-quickview">
                                <span class="fa fa-shopping-bag"></span>
                            </a>
                ...
                <div class="product-item pro-v1">
                    <div class="product-img">
                        <a href=""><img src="{{asset('')}}images/img48.jpg" alt="" class="img-responsive"></a>
                        <div class="sale-img shop1 shop2">
                            <div class="before shop1 v2 pro-v1 product-v2-before"></div>
                        </div>
                        <div class="ribbon zoa-hot shop-v1 product-v2"><span>New</span></div>
